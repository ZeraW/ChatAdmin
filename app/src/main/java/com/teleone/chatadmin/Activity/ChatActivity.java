...
import com.teleone.chatadmin.Adapter.ChatAdapter;
...
public class ChatActivity extends BaseActivity {
    ...
    protected void onStart() {
        ...
        mList.clear();
        getMsg();
        goOfline(getIntent().getStringExtra("userId"));
    ...
    private void chat(final String msg) {
        ...
        String myPerspective = "Chat/admin/" + hisID;
        Map<String, Object> chatMap = new HashMap<>();
        chatMap.put("msg", msg);
        chatMap.put("from", "admin");
        ...
        mFireStore.collection(myPerspective).add(chatMap).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
            ...
            public void onSuccess(DocumentReference documentReference) {
                ...
                new MobileToMobileMSG(ChatActivity.this).sendMSG("From : TeleOne",msg,hisID,"chat");
            }
    ...
    private void getMsg() {
        mFireStore.collection("Chat/admin/" + hisID).orderBy("time", Query.Direction.ASCENDING).addSnapshotListener(this, new EventListener<QuerySnapshot>() {
            @Override
