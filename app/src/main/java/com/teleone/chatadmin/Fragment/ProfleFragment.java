...
import com.teleone.chatadmin.Activity.LoginActivity;
...
public class ProfleFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
       ...
       /* mFireStore.collection("Admins").document(userId).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            @Override
